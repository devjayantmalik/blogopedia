...
const Content = () => {
    return (
        <article className="ui green text segment">
            <h1>The Plane Tree</h1>
            <p>
                Two Travellers, walking in the noonday sun, sought the shade of
                a widespreading tree to rest. As they lay looking up among the
            ...
            <p>Our best blessings are often the least appreciated.</p>
        </article>
    );
};
