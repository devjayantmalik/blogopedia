...
export default () => {
    return (
        <section className="ui text container mt-20">
            <article className="ui text segment article">
                <p>
                    ...
                    turned to flee, but finding that the Lion did not pursue
                    him, he turned back and went up to him.
                </p>
                <img
                    src="https://i.picsum.photos/id/164/600/200.jpg"
                    alt="placeholder"
                />
                <p>
                    As he came near, the Lion put out his paw, which was all
                    swollen and bleeding, and Androcles found that a huge thorn
                    had got into it, and was causing all the pain. He pulled out
                ...
                <p>
                    But shortly afterwards both Androcles and the Lion were
                    ...
                    spectacle, and Androcles was led out into the middle of the
                    arena. Soon the Lion was let loose from his den, and rushed
                    bounding and roaring towards his victim.
                </p>
                <p>
                    But as soon as he came near to Androcles he recognised his
                    ...
                    the slave was pardoned and freed, and the Lion let loose to
                    his native forest.
                </p>
                <img
                    src="https://i.picsum.photos/id/164/600/190.jpg"
                    alt="placeholder"
                />
                <p>
                    A slave named Androcles once escaped from his master and
